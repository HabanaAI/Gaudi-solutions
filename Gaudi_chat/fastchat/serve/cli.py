...
def main(args):
    ...
    try:
        chat_loop(args.model_path, args.device, args.num_gpus, args.max_gpu_memory,
            ...
            chatio, args.debug, args.use_graphs, args.use_cache, args.static_shapes, 
                args.context_len, args.output_tps, args.seed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="databricks/dolly-v2-12b", 
        help="The path to the weights")
    parser.add_argument("--device", type=str, choices=["cpu", "cuda", "mps", "hpu"], default="hpu")  
    ...
    parser.add_argument("--use_graphs", action="store_true")  
    parser.add_argument("--use_cache", action="store_true")   
    parser.add_argument("--static_shapes", action="store_true")  
    parser.add_argument("--output_tps", action="store_true", help="Display tokens per second after each query")
